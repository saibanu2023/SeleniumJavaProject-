...
WebDriver driver;
		...
		Select dropdownSkill = new Select(driver.findElement(By.xpath("//select[@id='Skills']")));
		 ...
		 Select dropdownYear  = new Select(driver.findElement(By.xpath("//select[@id='Skills']")));
		 dropdownYear.selectByValue("1926");
		 
	 Select dropdowMonth  = new Select(driver.findElement(By.xpath("//select[@id='Skills']")));
